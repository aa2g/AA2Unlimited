	...
	if (General::IsAAEdit) {
		...
		*/
		...
		Hook((BYTE*)address,
			...
			NULL);
		InsertRedirectCall((void*)redirectAddress, (void*)AAEdit::MeshTextureListStart);
	}
		...
		*/
		...
		Hook((BYTE*)address,
			...
			{ 0xE8, HookControl::RELATIVE_DWORD, redirectAddress },	//redirect to our function
			NULL);
		InsertRedirectCall((void*)redirectAddress, (void*)AAPlay::MeshTextureListStart);
	}
}
...
void OverrideTextureListNameInject() {
	if (General::IsAAEdit) {
		...
		InsertRedirectCall((void*)redirectAddress, (void*)AAEdit::MeshTextureListFill);
	}
	else if (General::IsAAPlay) {
...
void __declspec(naked) LoadLoopRedirect() {
	_asm {
		...
		push eax
		__asm nop __asm nop __asm nop __asm nop __asm nop //call AAEdit::MeshTextureStart //stdcall
		popad
	...
	if (General::IsAAEdit) {
		...
		*/
		...
		Hook((BYTE*)address,
			...
			NULL);
		InsertRedirectCall((void*)redirectAddress, (void*)AAEdit::MeshTextureStart);
	}
	else if (General::IsAAPlay) {
		//at this point, [esp+14] is the xx file buffer, [ebp] is the current offset
		...
		*/
		...
		Hook((BYTE*)address,
			...
			{ 0xE8, HookControl::RELATIVE_DWORD, redirectAddress,0x90 },	//redirect to our function
			NULL);
		InsertRedirectCall((void*)redirectAddress, (void*)AAPlay::MeshTextureStart);
	}
	...
	if (General::IsAAEdit) {
		...
		*/
		...
		Hook((BYTE*)address,
			...
			NULL);
		InsertRedirectCall((void*)redirectAddress, (void*)AAEdit::MeshTextureOverrideName);
		...
		*/
		...
		Hook((BYTE*)address,
			...
			{ 0xE9, HookControl::RELATIVE_DWORD, redirectAddress },	//redirect to our function
			NULL);
		InsertRedirectCall((void*)redirectAddress, (void*)AAPlay::MeshTextureOverrideName);
...
void __declspec(naked) OverrideFileSizeRedirect() {
	_asm {
		...
		push eax
		push ecx
		__asm nop __asm nop __asm nop __asm nop __asm nop //call AAEdit::MeshTextureOverrideSize
		popad
	...
	if (General::IsAAEdit) {
		...
		*/
		...
		Hook((BYTE*)address,
			...
			NULL);
		InsertRedirectCall((void*)redirectAddress, (void*)AAEdit::MeshTextureOverrideSize);
	}
	else if (General::IsAAPlay) {
		//gotta make sure that we change the meta-information of the image in the buffer
		...
		*/
		...
		Hook((BYTE*)address,
			...
			{ 0xE8, HookControl::RELATIVE_DWORD, redirectAddress, 0x90, 0x90 },	//redirect to our function
			NULL);
		InsertRedirectCall((void*)redirectAddress, (void*)AAPlay::MeshTextureOverrideSize);
	}
...
void OverrideFileInject() {
	if (General::IsAAEdit) {
		...
		*/
		...
		InsertRedirectCall((void*)redirectAddress, (void*)AAEdit::MeshTextureOverrideFile);
	}
	else if (General::IsAAPlay) {
		//this function is the memcpy(buffer, file, filesize). the parameters are
		//removed way down there. cdecl n stuff.
		...
		*/
		...
		Hook((BYTE*)address,
			...
			{ 0xE8, HookControl::RELATIVE_DWORD, redirectAddress },	//redirect to our function
			&OverrideFileOriginalCall);
		InsertRedirectCall((void*)redirectAddress, (void*)AAPlay::MeshTextureOverrideFile);
	}
}
