...
void __declspec(naked) OverrideTextureListSizeRedirect() {
	__asm {
		...
		push eax
		push edi
		call AAEdit::MeshTextureListStart
		test eax,eax
		mov edx, eax
		pop ecx
		pop eax
...
void __declspec(naked) OverrideTextureListNameRedirect() {
	__asm {
		...
		push esi 
		push ebp
		call AAEdit::MeshTextureListFill
		test eax, eax
		popad
...
void __declspec(naked) LoadLoopRedirect() {
	_asm {
		...
		push eax
		call AAEdit::MeshTextureStart //stdcall
		popad
...
void _declspec(naked) OverrideNameRedirect() {
	_asm {
		...
		call AAEdit::MeshTextureOverrideName
		test eax, eax
		popad
...
void __declspec(naked) OverrideFileSizeRedirect() {
	_asm {
		...
		push eax
		push ecx
		call AAEdit::MeshTextureOverrideSize
		popad
...
void __declspec(naked) OverrideFileRedirect() {
	_asm {
		...
		push eax
		call AAEdit::MeshTextureOverrideFile
		test eax,eax
		popad
