...
#define EXPR(ex) static_cast<float(*)(float)>([](float x)->float { return (ex); })
	...
	const std::vector<Slider> g_sliders[ExtClass::CharacterStruct::N_MODELS] = {
		...
		},
		{
			...
			{ ExtClass::CharacterStruct::SKELETON,75, TEXT("a01_J_MuneR_01"),{ 0,0,0, 0.1f,0.1f,0.1f, 0.1,-0.1,0 },	Slider::ADD, AAUCardData::MODIFY_FRAME }, //BalloonTits
			{ ExtClass::CharacterStruct::SKELETON,76, TEXT("a01_J_MuneL_01"),{ 0,0,0, 0.1f,0.1f,0.1f, -0.1,-0.1,0 },	Slider::ADD, AAUCardData::MODIFY_FRAME }, //BalloonTits
			{ ExtClass::CharacterStruct::SKELETON,77, TEXT("a01_J_MuneR_02"),{ 0,0,0, 0.1f,0.1f,0.1f, 0,0,0 },	Slider::ADD, AAUCardData::MODIFY_FRAME }, //BalloonTits
			{ ExtClass::CharacterStruct::SKELETON,78, TEXT("a01_J_MuneL_02"),{ 0,0,0, 0.1f,0.1f,0.1f, 0,0,0 },	Slider::ADD, AAUCardData::MODIFY_FRAME }, //BalloonTits
			{ ExtClass::CharacterStruct::SKELETON,79, TEXT("a01_J_ChikuR_01"),{ 0,0,0, 0,0,0.25f, 0,0,0 },	Slider::ADD, AAUCardData::MODIFY_FRAME }, //Breast Perkiness
			{ ExtClass::CharacterStruct::SKELETON,80, TEXT("a01_J_ChikuL_01"),{ 0,0,0, 0,0,0.25f, 0,0,0 },	Slider::ADD, AAUCardData::MODIFY_FRAME }, //Breast Perkiness
