...
local _M = {}
local opts = {
	{ "allstates", "22 26 28 36 42 43 57 58 93 151 152 157 158 159 172 180 181 222 223 224 225 228 235", "Force no-bra in all states of: %s"},
	{ "state1", "", "Force no-bra in state 1 of: %s" },
	{ "state3", "37 38 39 155 156 188 198 230 238 240 242", "Force no-bra in state 3 of: %s" },
}
